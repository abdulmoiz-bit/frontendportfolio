            ...
            <section className='contactme' id='contactme'>
                ...
                <div className="contacticons">
                    <div className="phoneno">
                        ...
                        <h4 style={{ textAlign: "center", color: "white", paddingTop: "1.6rem", fontFamily: 'Changa' }}>PHONE</h4>
                    ...
                    <div className="email">
                        ...
                        <h4 style={{ textAlign: "center", color: "white", paddingTop: "1.6rem", fontFamily: 'Changa' }}>EMAIL</h4>
