        ...
        <>
            <section className='about' id='about'>
                <div className='aboutmetext'>
                    ...
                    <p style={{ margin: '1rem 0rem' }}>I am Abdul Moiz Rashid,
                        I recently completed Software Engineering and I am a Frontend Engineer with React JS,
                        I have worked as a freelance frontend developer and developed many exciting projects shown some of them below.</p>
