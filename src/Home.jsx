            ...
            <main className='main'>
                ...
                <header className='header' id='header'>
                    <div className='iconbtn'>
                        <div className='icons'>
                            <a target="_blank" href="https://www.linkedin.com/in/abdul-moiz-rashid-8119751a6/">
                            ...
                            <a target="_blank" href='https://github.com/abdulmoiz-bit'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill='white' className="bi bi-github" viewBox="0 0 16 16">
                    ...
                    <div className='hero'>
                        <div className='intro' style={{ textAlign: 'center' }}>
                            <div className='heading' >
                                <h4 style={{ color: 'white', fontSize: '1.5rem' }}>Hi ! I am</h4>
                                <h1 style={{ fontFamily: 'Montserrat', fontSize: '3rem', color: 'rgba(255, 255, 255, 0.4)' }}>Abdul Moiz Rashid</h1>
                            ...
                            <div className='homebtns' style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
                                ...
                                <a href="#contactme" style={{ textDecoration: 'none' }}>
                                    <button className='homebtn'>Get In Touch</button>
                                </a>
                            </div>
                        </div>
                    </div>
